/*
 Leaflet.draw 1.1.2, a plugin that adds drawing and editing tools to Leaflet powered maps.
...
L.Edit.Rectangle = L.Edit.SimpleShape.extend({
	...
	_resize: function (latlng) {
		...
		var b = L.latLngBounds(latlng, this._oppositeCorner),
				sw = b.getSouthWest(),
				nw = b.getNorthWest(),
				ne = b.getNorthEast(),
				se = b.getSouthEast();

		this._shape.setLatLngs( [ sw, nw, ne, se ] );
